...
use Symfony\Component\HttpFoundation\RedirectResponse as SymfonyRedirectResponce;

class SocialProvidersController extends Controller
{
    public function redirect(string $driver): SymfonyRedirectResponce | RedirectResponse
    {
